...
> **Need a domain?** Get a free subdomain at the [Cosy Domain Provider](https://domain-provider.cosy-hosting.net) — claim a `*.cosy-hosting.net` subdomain and point it to your server's IP address in seconds.
