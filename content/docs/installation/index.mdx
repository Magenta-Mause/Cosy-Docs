...
New to this? The guide [Activate HTTPS With a Domain](/docs/guides/https-with-domain) walks through the whole thing step by step — getting a domain, pointing it at your server, and running the installer in TLS mode.
